...
class Game {
    ...
    displayBoard(){
        ...
        rows.push('  ➿➿➿➿➿➿➿➿➿➿➿');
        rows.push([Emoji.CornerStone, Emoji.Letter.A, Emoji.Letter.B, Emoji.Letter.C, Emoji.Letter.D, Emoji.Letter.E, Emoji.Letter.F, Emoji.Letter.G, Emoji.Letter.H].join(' '))
